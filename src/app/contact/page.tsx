  ...
  return (
    <main className="h-full flex mt-5 flex-col overflow-hidden min-h-screen ">
      ...
      <div className='flex flex-col mt-10 relative items-center mb-10 gap-10'>
        ...
        <div >
          <Link href="https://www.instagram.com/clubstampsuk/" target='_blank' className='font-sans py-3 group flex flex-row shrink-0 gap-2 text-xl justify-center items-center'>
            @clubstampsuk
            <span className='grayscale group-hover:grayscale-0'>
